...
import 'package:komet/core/media/tlottie/tlottie_disk_cache.dart';
...
void main() {
  ...
  test('disk cache round-trips rendered frames', () async {
    final tmp = Directory.systemTemp.createTempSync('tlottie_cache_test');
    ...
    await TlottieDiskCache.instance.store(
      url: url,
      px: px,
    ...
    final loaded = await TlottieDiskCache.instance.load(url, px);
    ...
    expect(await TlottieDiskCache.instance.load('https://other/x.json', px),
        isNull);
