...
class LiquidGlassDecor {
  static final Map<Color, _LiquidGlassParts> _cache = {};

  static _LiquidGlassParts _parts(Color base) {
...
class LiquidGlassPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, gradient, _) => _liquidGlass(context, gradient),
    );
  }


  Widget _liquidGlass(BuildContext context, bool gradient) {
    ...
    return RepaintBoundary(
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          gradient: gradient ? LiquidGlassDecor.fillGradient(base) : null,
          border: LiquidGlassDecor.rimBorder(base),
          boxShadow: [LiquidGlassDecor.dropShadow(base, depth)],
        ),
        child: ClipRRect(
          borderRadius: borderRadius,
          child: Stack(
              ...
              if (gradient) ...[
                ...
                Positioned.fill(
                  child: IgnorePointer(
                    child: DecoratedBox(
                      decoration: BoxDecoration(
                        gradient: LiquidGlassDecor.bottomShade(base),
                      ),
                    ),
                  ),
                ),
