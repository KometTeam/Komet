...
Условия использования неофициального клиента на MAX, именуемым "FuckmaxClient" или же "Fuckmax"

1. Статус и отношения
1.1. «Fuckmax» (далее — «Приложение») — неофициальное стороннее приложение, не имеющее отношения к ООО «Коммуникационная платформа" (правообладатель сервиса «MAX").
...
2.1. Используя Приложение «Fuckmax», вы:
...
• Использовать Приложение «Fuckmax» для распространения запрещённого контента;
...
• Приложение «Fuckmax» использует публично доступные методы взаимодействия с сервисом «MAX», аналогичные веб-версии (https://web.max.ru)
...
3.1. Приложение «Fuckmax» использует только публично доступные методы взаимодействия с сервисом «MAX» через официальные конечные точки.
...
4.1. Приложение «Fuckmax» не хранит и не обрабатывает персональные данные пользователей.
...
5.1. Приложение «Fuckmax» предоставляется «как есть» (as is) без гарантий работоспособности.
5.2. Разработчики вправе прекратить поддержку Приложения в любой момент без объяснения причин.

6. Правовые основания
6.1. Разработка и распространение Приложения «Fuckmax» осуществляются в соответствии с:
...
6.3. Приложение «Fuckmax» не обходит технические средства защиты и не нарушает нормальную работу оригинального сервиса, что соответствует требованиям статьи 1299 ГК РФ.

7. Заключительные положения
7.1. Используя Приложение «Fuckmax», вы соглашаетесь с тем, что:
...
8.1. Приложение «Fuckmax» включает инструменты защиты приватности:
...
8.4.1. Приложение «Fuckmax» предоставляет возможность экспорта и импорта данных сессии для:
